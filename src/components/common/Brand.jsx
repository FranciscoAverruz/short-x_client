...
const Brand = ({ classGrl, classTxt="lg:flex-row lg:gap-2", classIcon="w-12", classP, classTsx }) => {
  return (
    <article className={`flex flex-row items-center gap-2 ${classGrl}`}>
        <img src={logo} alt="Logo" className={`drop-shadow-md ${classIcon}`} />
        <div className={`flex flex-col items-start lg:items-baseline md:mb-0 ${classTxt}`}>
