...
//   const { t } = useTranslation();
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <label htmlFor="toggle-dark" className=" lg:flex items-center cursor-pointer">
        <Input
          type="checkbox"
          id="toggle-dark"
          className="sr-only"
        ...
        <div className="relative">
          <div className={` ${isDarkMode ? 'bg-gray-800' : 'bg-white'} w-[59px] h-8 rounded-full shadow-md transition-colors duration-300`}></div>
