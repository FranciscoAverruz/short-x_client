...
const UrlDetailCard = ({title, clicks, icon, className}) => {
  return (
    <aside className={`flex grlTxt grlContainer flex-col justify-center items-center gap-4 p-5 w-full ${className}`}>
        <article className="flex flex-row justify-between lg:justify-center lg:gap-10 items-center w-full">
            ...
            <strong className="text-sm lg:text-lg self-end lg:self-center">{title}</strong>
    </aside>
  )
}
