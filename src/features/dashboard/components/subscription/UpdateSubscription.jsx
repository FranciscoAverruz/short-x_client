        ...
        >
          <aside className="flex flex-col justify-between h-full w-full">
            ...
            <article className="flex flex-col md:flex-row lg:flex-col md:gap-5 lg:gap-0 md:w-full md:justify-center">
              {/* <section className="relative flex flex-row lg:flex-row items-end p-0 w-full bg-pink-400"> */}
              <section className="relative grid grid-cols-3 items-end">
                ...
                <span className="absolute left-4 top-10 transform text-amber-500 font-semibold text-lg col-span-2">
                  <PlanLabel plan={newPlan} /> {/* this will show over id="newPlan" */}
                </span>
                <Button
                  label="Cambiar"
                  onClick={() => setModalOpen(true)}
                  className="h-[2.6rem] m-0 px-4 md:px-2 text-xs rounded-none rounded-r-lg inputStyle top-0 hover:brightness-125 col-span-1"
                  variant="secondary"
                />
              </section>
              <SubmitButton
                ...
                newPlan === "free_monthly" || newPlan === "free_annual" ? (
                  <aside className="flex flex-col justify-center items-center grlTxt">
                    <p>
                      ...
                      a plan 
                      <strong className="smart text-xl mx-2">Free</strong>, se
                      completará el dia:
                    </p>
                    ...
                    <p>
                      podrás continuar usando tu plan actual hasta esa fecha
                    </p>
                  </aside>
                ) : upcomingPayment ? (
