            ...
            {buttons.map((button, index) => {
              ...
              return (
                <Button
                  ...
                  icon={
                    (hoveredLink === button.label || isActive) && button.icon
                      ? button.icon.active
                      : button.icon?.default
                  }
                  className={`grlTxt profileMenuItems flex justify-start hover:text-light-hoverTitle dark:hover:text-dark-hoverTitle hover:brightness-100 font-semibold ${
                    isActive
                      ? "text-light-hoverTitle dark:text-dark-hoverTitle bg-light-btnMenuHoverBg/10 dark:bg-dark-btnMenuHoverBg opacity-100 brightness-100"
                      : ""
                  }`}
                />
              );
